...
class Inference:
    ...
    """
    image is expected to be of shape [N, H, W, 13] with all the Sentinel-2 Bands if 
    self.all_bands = True otherwise [N, H, W, C] with the bands required by s2cloudless
    """
